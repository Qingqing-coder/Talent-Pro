        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="公司名称">
              <el-input v-model="conditionForm.companyName" clearable class="custom-input" placeholder="输入公司名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="公司规模">
              <el-select v-model="conditionForm.companySize" clearable placeholder="请选择" class="custom-select">
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="薪水" prop="salary">
              <el-input v-model="form.salary" clearable placeholder="如 16K-28K" class="custom-input" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
